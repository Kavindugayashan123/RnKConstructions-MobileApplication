...
public class addRegister extends AppCompatActivity {
    ...
    private ImageView closebtn,pImageView;
    ...
    private  String rname,rpass,timeStamp;
    Dialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this,R.id.username, RegexTemplate.NOT_EMPTY,R.string.not_null);
        awesomeValidation.addValidation(this,R.id.password, RegexTemplate.NOT_EMPTY,R.string.not_null);
        awesomeValidation.addValidation(this,R.id.repassword, RegexTemplate.NOT_EMPTY,R.string.not_null);
        ...
        pImageView=findViewById(R.id.Re_personImage);
            ...
            public void onClick(View v) {
                if (awesomeValidation.validate()) {
                   ...
                   /* if (user.equals("") || pass.equals("") || repass.equals(""))
                        Toast.makeText(addRegister.this, "Please enter all the field", Toast.LENGTH_SHORT).show();
                    else {*/
                        if (pass.equals(repass)) {
                            ...
                            if (checkuser == false) {
                                ...
                                //Toast.makeText(addRegister.this, "Register successful", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(addRegister.this, "user already exists!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(addRegister.this, "Password not matching", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void getData() {
        ...
        rname= ""+username.getText().toString().trim();
        rpass = ""+password.getText().toString().trim();
        timeStamp = ""+System.currentTimeMillis();


        long RID = DB.insertInfoR(
                ""+rname,
                ""+rpass,
                ""+imageUri,
                ""+timeStamp,
